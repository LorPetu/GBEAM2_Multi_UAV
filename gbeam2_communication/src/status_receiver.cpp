...
class StatusRXNode : public rclcpp::Node
{
public:
  StatusRXNode() : Node("status_RX"){
  ...
  void setup_synchronizer()
  {
    ...
    switch (subscribers_.size()) {
      case 1:
        ...
        subscribers_[0]->registerCallback(std::bind(&StatusRXNode::callback1, this, std::placeholders::_1));
        break;
      case 2:
        sync_2_ = std::make_shared<message_filters::Synchronizer<ApproxTime2>>(ApproxTime2(10), *subscribers_[0], *subscribers_[1]);
        sync_2_->registerCallback(std::bind(&StatusRXNode::callback2, this, std::placeholders::_1, std::placeholders::_2));
        break;
      case 3:
        ...
        sync_3_->registerCallback(std::bind(&StatusRXNode::callback3, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
        break;
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<StatusRXNode>();
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
